...
public class DdcilTestContainer extends TestContainer {

    public DdcilTestContainer() {
        super();
    ...
    public static class Common extends DdcilTestContainer {

        public static final DdcilTestContainer.Common INSTANCE = new DdcilTestContainer.Common();
